                        ...
                        <td>
                          {
                            data.return_status ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#41f1b6" className="w-5 h-5">
                              ...
                              setBorrowerRowData({ bId: data.id, name: data.item.name, bName: data.b_name, admno: data.adm_no, sem: data.sem, branch: data.branch, date: data.date, phone: data.phone, sName: data.item.stock.name })
